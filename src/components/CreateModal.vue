...
<script>
import { createNewContactService } from "../service/CRUDService.js"
export default {
    data() {
        return {
            contact: {
    ...
    methods: {
        async createNewContact() {
            let res = await createNewContactService(this.contact);
            console.log(res)
            if (res.errCode === 0) {
                alert(res.mes)
                this.$emit("emitCloseCreateModal")
            }
        },
        emitCloseCreateModal() {
            this.$emit("emitCloseCreateModal")
        }
    }
}
...
<template>
    <div id="CreateModal">
        ...
        <div class="main">
            <div class="top">
                Create New Contact
                <div class="btn_close" @click="emitCloseCreateModal()">
            ...
            <div class="bottom">
                <button class="save" @click="createNewContact()">
